            ...
            container.innerHTML = `
                <div style="text-align: center; padding: 1.5rem 0;">
                    ...
                    <button type="button" class="checkout-btn" 
                        style="background: #fff; color: #374151; border: 2px solid #e2e8f0; display: flex; align-items: center; justify-content: center; gap: 12px; margin: 0 auto 1.5rem; transition: all 0.2s;"
                    ...
                    <p style="font-size: 0.72rem; color: #94a3b8; margin-top: 1rem; max-width: 250px; margin-left: auto; margin-right: auto;">
        ...
        function renderUserProfile() {
            ...
            container.innerHTML = `
                <div class="user-logged-in" style="max-height: 80vh; overflow-y: auto; padding: 10px 20px 20px 5px;">
                    ...
                    ${['samuelpauljalli@gmail.com', 'wilsonhealthcare7@gmail.com'].includes(currentUser.email?.toLowerCase()) ? `
                    <div style="text-align: center; margin-bottom: 1.5rem;">
                        <a href="peter.html" style="display: inline-flex; align-items: center; gap: 8px; background: #0f172a; color: white; padding: 10px 20px; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 0.9rem; box-shadow: 0 4px 15px rgba(15, 23, 42, 0.3); transition: transform 0.2s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                            <i class="fas fa-user-shield" style="color: #4ade80;"></i>
                            Access Admin Panel
                        </a>
                    </div>
                    ` : ''}
                    ...
                    <form onsubmit="saveProfileDetails(event)" class="login-form" style="text-align: left; gap: 1.2rem; padding: 0 5px;">
                        <div class="form-group" style="gap: 0.4rem;">
                            <label style="font-size: 0.85rem; color: var(--secondary); display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-user" style="color: var(--primary); width: 15px;"></i> Full Name <span style="color:red">*</span>
                            </label>
                        ...
                        <div class="form-group" style="gap: 0.4rem;">
                            <label style="font-size: 0.85rem; color: var(--secondary); display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-phone" style="color: var(--primary); width: 15px;"></i> Mobile Number <span style="color:red">*</span>
                            </label>
                            <input type="tel" id="prof-mobile" value="${user.mobile}" placeholder="Enter 10-digit mobile number" style="padding: 0.75rem 1rem; font-size: 0.95rem; border: 2px solid #e2e8f0; border-radius: 12px; width: 100%; box-sizing: border-box;">
                        </div>
                        <div class="form-group" style="gap: 0.4rem;">
                            <label style="font-size: 0.85rem; color: var(--secondary); display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-envelope" style="color: var(--primary); width: 15px;"></i> Email Address <span style="color:red">*</span>
                            </label>
                        ...
                        <div style="border-top: 1px solid #f1f5f9; padding-top: 1.2rem; margin-top: 0.5rem;">
                            <p style="font-size: 0.85rem; font-weight: 700; color: var(--primary); margin-bottom: 1rem; display: flex; align-items: center; gap: 8px;">
                                ...
                                <button type="button" onclick="checkAddressOnMaps()" style="margin-left: auto; font-size: 0.7rem; padding: 2px 8px; background: #fff; border: 1px solid var(--primary); color: var(--primary); border-radius: 4px; cursor: pointer;">
                                    <i class="fas fa-map-marked-alt"></i> Check on Maps
                                </button>
                            </p>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group" style="gap: 0.4rem;">
                                <label style="font-size: 0.75rem; color: var(--text-light);">House/Door No. <span style="color:red">*</span></label>
                            ...
                            <div class="form-group" style="gap: 0.4rem;">
                                <label style="font-size: 0.75rem; color: var(--text-light);">Street / Area <span style="color:red">*</span></label>
                        ...
                        <div class="form-grid">
                            <div class="form-group" style="gap: 0.4rem;">
                                <label style="font-size: 0.75rem; color: var(--text-light);">PIN Code <span style="color:red">*</span></label>
                            ...
                            <div class="form-group" style="gap: 0.4rem;">
                                <label style="font-size: 0.75rem; color: var(--text-light);">City / District <span style="color:red">*</span></label>
                        ...
                        <div class="form-grid">
                            <div class="form-group" style="gap: 0.4rem;">
                                <label style="font-size: 0.75rem; color: var(--text-light);">State <span style="color:red">*</span></label>
                ...
                <div class="product-card" onclick="if(!event.target.closest('button')) showProductInfo('${p.id}')">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-rating">
                            ...
                            <span>(${p.ratingCount || 50})</span>
                        </div>
                        <div class="product-price">
                            ${p.price ? `
                                <span class="current-price">₹${Number(p.price).toLocaleString('en-IN')}</span>
                                ${p.oldPrice ? `<span class="old-price">₹${Number(p.oldPrice).toLocaleString('en-IN')}</span>` : ''}
                        ...
                        <div class="product-actions" style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px;">
                            ...
                            <button class="wish-btn ${wishlist.includes(String(p.id)) || wishlist.includes(Number(p.id)) ? 'active' : ''}" style="width: 42px; height: 42px;" onclick="toggleWishlist('${p.id}')">
                                <i class="${wishlist.includes(String(p.id)) || wishlist.includes(Number(p.id)) ? 'fas' : 'far'} fa-heart"></i>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            track.innerHTML = displayItems.map(p => `
                <div class="rv-item" onclick="showProductInfo('${p.id}')">
                    ...
                    <div class="rv-item-info">
                        ...
                        <div class="rv-item-price">₹${(p.price || 0).toLocaleString('en-IN')}</div>
                    </div>
                </div>
            `).join('');
            ...
            container.innerHTML = items.map(p => `
                <div class="cart-item wishlist-item">
                    ...
                    <div style="display: flex; gap: 8px;">
                        <button class="add-cart-btn" style="padding: 0.4rem 0.8rem; font-size: 0.75rem; border-radius: 8px;" onclick="addToCart('${p.id}')">Add</button>
                        <button onclick="toggleWishlist('${p.id}')" style="background: #fee2e2; color: #ef4444; border: none; padding: 0.4rem; border-radius: 8px; cursor: pointer;">
        ...
        function checkout() {
            ...
            preview.innerHTML = cart.map(item => `
                <div style="display: flex; align-items: center; gap: 10px; padding: 8px 0; border-bottom: 1px solid #f8fafc; text-align: left;">
                    ...
                    <div style="flex: 1;">
                        <div style="font-size: 0.85rem; font-weight: 600; color: var(--secondary); max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${item.name}</div>
                        <div style="font-size: 0.75rem; color: var(--text-light);">Qty: ${item.quantity} × Rs ${item.price.toLocaleString('en-IN')}</div>
                    </div>
                </div>
            `).join('');
            ...
            container.innerHTML = clearBtnHtml + orders.map(order => `
                <div class="order-card" id="order-${order.orderId}">
                    <div class="order-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                        ...
                        <span style="font-size: 0.8rem; color: var(--text-light);">${new Date(order.date).toLocaleDateString()}</span>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                        <strong>Total: ₹${order.total.toLocaleString('en-IN')}</strong>
                        <span class="status-badge ${order.status === 'Cancelled' ? 'cancelled' : 'success'}" 
                              style="font-size: 0.75rem; padding: 2px 8px; border-radius: 4px; background: ${order.status === 'Cancelled' ? '#fee2e2' : '#dcfce7'}; color: ${order.status === 'Cancelled' ? '#ef4444' : '#166534'};">
                            ${order.status || 'Placed'}
                        </span>
                    </div>
                    <div style="font-size: 0.8rem; margin-bottom: 1rem; color: #64748b;">
